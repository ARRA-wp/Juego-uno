...
var span = document.getElementById('saludo');
...
socket.on('turnPlayer', function (data) {
  if (data === socket.id) {
    turn = true;
    alert("Tu turno");
    document.getElementById('p1').innerHTML = 'Tu turno';
    console.log('<< Your turn');
    arrow();
  } else {
    turn = false;
    document.getElementById('p2').innerHTML = 'Turno del contrincante';
    alert("Turno de tu contrincante");
